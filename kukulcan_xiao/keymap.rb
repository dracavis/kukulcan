...
kbd.add_layer :default, %i(
  ...
  KC_LSFT KC_NO   KC_Z    KC_X    KC_C    KC_V    KC_B    KC_NO        KC_B     KC_N           KC_M          KC_COMM        KC_DOT         KC_SLSH  KC_UP   KC_END
  KC_LCTL KC_LGUI KC_LALT ENT_L1  KC_NO   KC_SPC  KC_NO   KC_NO        SPC_L2   KC_MHEN        KC_RALT       KC_RCTL        KC_NO          KC_LEFT  KC_DOWN KC_RGHT
)
kbd.add_layer :layer1, %i(
  ...
  KC_LCTL KC_BSPC KC_DEL  ENT_L1  KC_NO   KC_ENT  KC_NO   KC_NO        KC_LEFT  KC_DOWN         KC_UP         KC_RIGHT       KC_NO          KC_9     KC_0    L3
)
...
kbd.define_mode_key :ENT_L1,    [ :KC_ENT,                  :layer1,   200,  200 ]
kbd.define_mode_key :SPC_L2,    [ :KC_SPACE,                :layer2,   200,  200 ]
kbd.define_mode_key :L3,        [ nil,                      :layer3,   nil,  nil ]
